...
--
-- Host: localhost
-- Generation Time: Dec 05, 2017 at 09:56 AM
...
('m000000_000000_base', 1510562110),
('m171113_082133_create_post_table', 1510562270),
('m171120_085740_create_table_monstertest', 1511168830),
('m171120_133034_create_table_monster', 1511184836);
...
INSERT INTO `monster` (`id`, `name`, `age`, `gender`, `username`, `password`, `authKey`) VALUES
(18, 'Dracule', 999, 'm', 'fangman999', '$2y$10$8FhEwMF.NdVCPfU4Tf4esO1ENDmmdRFjItSxAcRXPobNMXufrcg4O', ''),
(19, 'Frankenstein', 2, 'm', 'stitchedtogether', '$2y$10$2yNtFKAmwjOTHKx9zSG2ou6Wxijz/3YzzDSHyLSberUKsJTPKSaA2', ''),
(20, 'Mummy', 86, 'm', 'dirtyragdude', '$2y$10$jYaJqB8pQdwMiVKPJttvQ.R9xiMBSsi6PqVWUdfCOhIcMKpyn1/6i', ''),
(21, 'Wicked Witch', 40, 'f', 'broomrider4eva', '$2y$10$ze86BA6m46Ynapy7s0WLKe49WizzkUj9QkNugUTve8z1ZMYDJhl6y', ''),
(22, 'Medusa', 34, 'f', 'shakehairgirl', '$2y$10$yGbj3AAj2TBXeH2dvRoc/.IBEd.KVrqI6ZEFLUXm8AFvvPhU/VQlC', ''),
(23, 'Elvira', 38, 'f', 'Ellybell', '123456', '');

-- --------------------------------------------------------

--
-- Table structure for table `monstertest`
--
...
--
-- Dumping data for table `monstertest`
--

INSERT INTO `monstertest` (`id`, `name`, `age`, `gender`) VALUES
(1, 'Dracula', 998, 'm'),
(2, 'Frankenstein', 2, 'm'),
(3, 'Medusa', 34, 'f'),
(4, 'Mummy', 86, 'm'),
...
(1, 'Test article #1', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim'),
(2, 'Test article #2', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim'),
(3, 'Test article #3', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim'),
(4, 'Test article #4', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim'),
(5, 'Test article #5', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim'),
(6, 'Test article #6', 'lorem ipsun.......sed si amet.phasellus arcu massarhonus ut enim');
...
--
-- Indexes for table `monstertest`
--
ALTER TABLE `monstertest`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `monstertest`
--
ALTER TABLE `monstertest`
